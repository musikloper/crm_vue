...
const mutations = {
    ...
    SOCKET_LOGIN (state, accessToken) {
        state.accessToken = accessToken
        localStorage.accessToken = accessToken
    },
    SOCKET_USERINFO (state, user) {
        // console.log(user)
        state.AppActiveUser.uid = user.m_uid;
        state.AppActiveUser.email= user.m_email;
        state.AppActiveUser.name = user.m_name;
        state.AppActiveUser.level = user.m_level;
        state.AppActiveUser.image = user.m_image;
    },
