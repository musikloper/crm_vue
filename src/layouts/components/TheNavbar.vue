      ...
      <div class="the-navbar__user-meta flex items-center sm:ml-5 ml-2">
        ...
        <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
          <div class="con-img ml-3">
              <!-- <img :src="require(`@/assets/images/portrait/small/${activeUserInfo.img}`)" alt="" width="40" height="40" class="rounded-full shadow-md cursor-pointer block"> -->
          ...
          <vs-dropdown-menu>
            ...
            <ul style="min-width: 9rem">
              <!-- <li class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white" @click="$router.push('/MyPage')"><feather-icon icon="UserIcon" svgClasses="w-4 h-4"></feather-icon> <span class="ml-2">MyPage</span></li> -->
